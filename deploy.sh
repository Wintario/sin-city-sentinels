...
# ============================================================================
# 🐰 SIN CITY SENTINELS - PRODUCTION DEPLOYMENT SCRIPT v3.0
# ============================================================================
# Автоматическое развёртывание сайта клана "Свирепые Кролики"
# 
# Что делает скрипт:
#   - Останавливает старые процессы (PM2, Node.js, Nginx)
...
#   - Создаёт директории для загрузок и аватарок
